...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='datasets/RFCP/test',
                        help='origin data directory')
    parser.add_argument('--save-dir', default='ckpt/RFCP/RapeNet',
            ...
            with torch.set_grad_enabled(False):
                ...
                for label in listdir(labels_dir):
                    ...
                    if labels_name == image_name:
                        ...
                        plt.savefig('{}/{}.png'.format(save_im_dir, image_name), bbox_inches='tight', dpi=600)
                        plt.close()
