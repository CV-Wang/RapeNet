...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='datasets/RFRB_processed',
                        help='training data directory, datasets/RFRB_processed, datasets/RFCP_processed')
    parser.add_argument('--save-dir', default='ckpt/new/RapeNet',
    ...
    parser.add_argument('--background-ratio', type=float, default=0.35,
